...
class DCGAN(object):
    ...
    def discriminator(self, image, y=None, reuse=False):
        with tf.variable_scope("discriminator") as scope:
            ...
            h0 = lrelu(self.d_bn1(conv2d(image, 2, name='d_h0_conv', k_h=3, k_w=3)), leak=0.3)
            h1 = lrelu(self.d_bn2(conv2d(h0, 4, name='d_h1_conv', k_h=3, k_w=3)), leak=0.3)
            h2 = lrelu(self.d_bn3(conv2d(h1, 8, name='d_h2_conv', k_h=3, k_w=3)), leak=0.3)
